...
// When a GET request is made to /comptBanquaire
// Our app will return an array with a list of all
// ComptBanquaire including name and title
// this data is defined in our `database-seed.sql` file
app.get("/ComptBanquaire", async (req, res) => {
  const results = await client
    .query("SELECT * FROM ComptBanquaire")
    .then((payload) => {
      return payload.rows;
    })
    .catch(() => {
